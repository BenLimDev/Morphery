...
;
String txt1 =
"2.	Type of graph: A straight line with a positive gradient that does not pass through the origin Interpretation of graph: \n• y increases linearly with x \n• Gradient of graph, m = Δy/ Δx m = y2 – y1/ x2 – x1\n• y-intercept = c \n• Linear equation, y = mx + c";
String? img2 
= 'img/pg11.2.jpg'
;
String txt2 =
...
class C22 extends StatefulWidget {
  const C22({Key? key, required this.lockedStyle}) : super(key: key);
  final String lockedStyle; 
  @override
  State<C22> createState() => _ArticleScreenState();
}
class _ArticleScreenState extends State<C22> {
