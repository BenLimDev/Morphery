...
class B11 extends StatefulWidget {
  const B11({Key? key, required this.lockedStyle}) : super(key: key);
  final String lockedStyle; 
  @override
  State<B11> createState() => _ArticleScreenState();
}
class _ArticleScreenState extends State<B11> {
