...
class B21 extends StatefulWidget {
  const B21({Key? key, required this.lockedStyle}) : super(key: key);
  final String lockedStyle; 
  @override
  State<B21> createState() => _ArticleScreenState();
}
class _ArticleScreenState extends State<B21> {
