...
class B17 extends StatefulWidget {
  const B17({Key? key, required this.lockedStyle}) : super(key: key);
  final String lockedStyle; 
  @override
  State<B17> createState() => _ArticleScreenState();
}
class _ArticleScreenState extends State<B17> {
