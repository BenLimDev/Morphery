...
class B13 extends StatefulWidget {
  const B13({Key? key, required this.lockedStyle}) : super(key: key);
  final String lockedStyle; 
  @override
  State<B13> createState() => _ArticleScreenState();
}
class _ArticleScreenState extends State<B13> {
